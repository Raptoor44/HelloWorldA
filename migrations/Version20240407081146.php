 ...
 */
final class Version20240407081146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE log (id INT NOT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id_controller INT NOT NULL, content VARCHAR(255) NOT NULL, id_route INT NOT NULL, PRIMARY KEY(id))');
